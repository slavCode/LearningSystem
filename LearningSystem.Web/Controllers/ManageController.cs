namespace LearningSystem.Web.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> Index(IndexViewModel model)
        {
            ...
            if (nameIsChanged) user.Name = model.Name;

            var birthdayIsChanged = model.Birthday != user.Birthday;
            if (birthdayIsChanged) user.Birthday = model.Birthday;
        ...
        public IActionResult ResetAuthenticatorWarning()
           => View(nameof(ResetAuthenticator));
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                urlEncoder.Encode("LearningSystem.Web"),
